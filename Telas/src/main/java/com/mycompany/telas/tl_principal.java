...
public class tl_principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBoxMenuItem9.setText("Agendar Consulta");
        jMenu4.add(jCheckBoxMenuItem9);

        jMenuItem1.setText("Lista de Agendamento");
        ...
        jCheckBoxMenuItem2.setText("Buscar Paciente");
        ...
        jCheckBoxMenuItem8.setText("Cadastro de Convênio");
        ...
        jCheckBoxMenuItem4.setText("Cadastrar Funcionário");
        jMenu5.add(jCheckBoxMenuItem4);

        jCheckBoxMenuItem5.setSelected(true);
        jCheckBoxMenuItem5.setText("Adicionar, Remover ou  Substituir Funcionário");
        jMenu5.add(jCheckBoxMenuItem5);

        jCheckBoxMenuItem6.setSelected(true);
        jCheckBoxMenuItem6.setText("Lista de Funcionários");
        jMenu5.add(jCheckBoxMenuItem6);

        jCheckBoxMenuItem7.setSelected(true);
        jCheckBoxMenuItem7.setText("Relatório de Pontualidade");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tl_principal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
